"""
Python Song 1.0 — Terminal Lyric Player (Windows Edition)
Author: itxashancode
...
# --- Global Toggle for Colors (Fix: default True — modern Windows terminals support ANSI) ---
ENABLE_COLORS = True
...
if ENABLE_COLORS:
    ...
    class Colors:
        HEADER = CYAN = BLUE = GREEN = YELLOW = RED = END = BOLD = ""
        MAGENTA = LIGHTCYAN = ORANGE = LIGHTGREEN = PURPLE = LIGHTBLUE = ""
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Python Song 1.0 — Terminal Lyric Player (Windows Edition)"
    )
    parser.add_argument(
